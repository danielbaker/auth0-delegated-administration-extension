...
export const FETCH_INVITES_PENDING = 'FETCH_INVITES_PENDING';
export const FETCH_INVITES_REJECTED = 'FETCH_INVITES_REJECTED';
export const FETCH_INVITES_FULFILLED = 'FETCH_INVITES_FULFILLED';

// Fetch single invite.
export const FETCH_INVITE = 'FETCH_INVITE';
export const FETCH_INVITE_PENDING = 'FETCH_INVITE_PENDING';
export const FETCH_INVITE_REJECTED = 'FETCH_INVITE_REJECTED';
export const FETCH_INVITE_FULFILLED = 'FETCH_INVITE_FULFILLED';

// Cancel invite.
export const REQUEST_CANCEL_INVITE = 'REQUEST_CANCEL_INVITE';
export const CANCEL_REQUEST_CANCEL_INVITE = 'CANCEL_REQUEST_CANCEL_INVITE';
export const CANCEL_INVITE = 'CANCEL_INVITE';
export const CANCEL_INVITE_PENDING = 'CANCEL_INVITE_PENDING';
export const CANCEL_INVITE_REJECTED = 'CANCEL_INVITE_REJECTED';
export const CANCEL_INVITE_FULFILLED = 'CANCEL_INVITE_FULFILLED';

// Resend invite.
export const REQUEST_RESEND_INVITE = 'REQUEST_RESEND_INVITE';
export const CANCEL_REQUEST_RESEND_INVITE = 'CANCEL_REQUEST_RESEND_INVITE';
export const RESEND_INVITE = 'RESEND_INVITE';
export const RESEND_INVITE_PENDING = 'RESEND_INVITE_PENDING';
export const RESEND_INVITE_REJECTED = 'RESEND_INVITE_REJECTED';
export const RESEND_INVITE_FULFILLED = 'RESEND_INVITE_FULFILLED';
