...
<html lang="en">
  <head>
    ...
    {{ #if settings.customCss }} 
      <link rel="stylesheet" type="text/css" href="{{ settings.customCss }}" />
    {{ /if }}
    <style>
  ...
  <header class="dashboard-header">
    <nav title="header" role="navigation" class="navbar navbar-default">
      <div class="container">
      <div id="header" class="navbar-header" style="width: 800px;">
        <span class="navbar-brand">Accept Invitation</span>
      </div>
    </nav>
  </header>
  <div class="container">
    ...
    {% if invite == blank %}
      <h2>Invitation is either expired or invalid.</h2>
    {% else %}
      <h2>You have been invited to the application</h2>
      <form>
